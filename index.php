...
<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: rgb(72 72 72 / 24%);">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#home" style="font-family: 'Courier New', Courier, monospace;">Home
                <span class="sr-only">(current)</span>
              </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#consultus" style="font-family: 'Courier New', Courier, monospace;" >Consult Us</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#availablemedicines" style="font-family: 'Courier New', Courier, monospace;">Available Medicines</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="row justify-content-center">
      <div class="col-5 md-5 mt-5 bg-light rounded">
         <h1 class="text-center font-weight-bold text-primary" style="font-family: 'Courier New', Courier, monospace;">Consult Us</h1>
        <hr class="bg-light">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3 item">
                        ...
                        <ul>
                            ...
                            <li><a href="#availablemedicines">Available Medicines</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-md-3 item">
                        <h3>About</h3>
                    ...
                    <div class="col item social"><a href="https://www.facebook.com/ctunagaclinic"><i class="icon ion-social-facebook"></i></a><a href="#"><i class="icon ion-social-twitter"></i></a><a href="#"><i class="icon ion-social-snapchat"></i></a><a href="#"><i class="icon ion-social-instagram"></i></a></div>
                </div>
                <p class="copyright">Arkiollezan © 2022</p>
            </div>
        </footer>
    </div>
